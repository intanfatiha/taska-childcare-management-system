<x-app-layout>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <button onclick="recordTime(this)" 
                                                class="bg-blue-500 text-white text-xs py-1 px-2 rounded hover:bg-blue-700 focus:outline-none">
                                            Time In
                                        </button>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
    ...
    <script>
        function recordTime(button) {
            // Get the current time in HH:MM format
            const currentTime = new Date().toLocaleTimeString('en-US', {
                hour: '2-digit',
                minute: '2-digit'
            });
            // Update the button text to display the current time
