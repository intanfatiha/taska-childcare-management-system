    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-gradient-to-r from-indigo-50 to-purple-100 p-6 rounded-lg shadow-sm">
                ...
                <p class="text-gray-600 mt-1">Share important information with your organization</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                <form action="{{ route('announcements.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        placeholder="Enter announcement title" value="{{ old('announcement_title') }}" required>
                    ...
                    <div class="mb-5">
                        ...
                        <select name="announcement_type" id="announcement_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            ...
                            <option value="Notice" {{ old('announcement_type') == 'Notice' ? 'selected' : '' }}>Notice</option>
                            <option value="Update" {{ old('announcement_type') == 'Update' ? 'selected' : '' }}>Update</option>
                            <option value="Other" {{ old('announcement_type') == 'Other' ? 'selected' : '' }}>Other</option>
                        </select>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="announcement_location" id="announcement_location" 
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" 
                            placeholder="Enter location (optional)" value="{{ old('announcement_location') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="activity_description" id="activity_description" rows="4" 
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" 
                            placeholder="Describe the announcement in detail">{{ old('activity_description') }}</textarea>
